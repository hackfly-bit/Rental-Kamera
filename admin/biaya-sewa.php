              ...
              <div class="card-body">
                <table id="display-kamera" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th width="200px" style="text-align: center; vertical-align: middle;">Gambar</th>
                    <th style="text-align: center; vertical-align: middle;">Nama Kamera</th>
                    <th width="150px" style="text-align: center; vertical-align: middle;">Biaya Sewa</th>
                    <th width="150px" style="text-align: center; vertical-align: middle;">Stock</th>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle;"><img src="#" alt="gambar" srcset=""></td>
                    <td style="vertical-align: middle;">Canon EOS 6D Body Built-In Wifi And GPS</td>
                    <td style="text-align: center; vertical-align: middle;">200.000 /hari</td>
                    <td style="text-align: center; vertical-align: middle;">6</td>
                    <td><button type="button" class="btn btn-block btn-success">Edit</button>
                        <button type="button" class="btn btn-block btn-danger">Hapus</button></td>
                  </tr>
                  </tbody>
